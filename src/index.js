...
`;
  ...
  const applyThemeToHost = (themeName) => {
    ...
    if (themingMode === 'hosted') {
      // In hosted mode the embedding app owns the outer theme variables.
      // We only need the theme object here so CodeMirror can be reconfigured.
    } else {
